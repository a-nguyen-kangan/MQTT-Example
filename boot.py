...
# ssid = "Anh-iPhone"
# password = 'dromana1234'
# ssid='AVENGER-MANSE_optout'
# password='catdogpigcow'
ssid = 'CyFi'
password = 'SecurityA40'
mqtt_server = b'fe6076df55bd4037a34ea51f278949bf.s1.eu.hivemq.cloud'
...
#     cacert = f.read()
# print('Obtained CA Certificate', cacert)
